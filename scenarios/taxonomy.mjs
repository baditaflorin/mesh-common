...
const rules = [
  ...
  [
    ...
    ["research", "workshops", "small groups"],
  ],
  [
    /message-drop/,
    "Social",
    "Conversation & connection",
    ["friends", "events", "small groups"],
  ],
  [
    /countdown-wall/,
    "Coordination",
    "Planning & logistics",
    ["workshops", "meetings", "sprints"],
  ],
  [
    /invite-pocket/,
    "Privacy & utilities",
  ...
  [
    ...
    "Decisions",
    "Selection & ranking",
    ["prioritization", "workshops", "teams"],
  ],
  [
    /rating-board/,
    "Decisions",
    "Voting & consensus",
    ["feedback", "workshops", "teams"],
  ],
  [
    /word-cloud/,
    "Creative",
    "Writing & storytelling",
    ["reflection", "workshops", "teams"],
  ],
  [
    /lucky-draw/,
    "Games",
    "Party & tabletop",
    ["icebreakers", "game night", "events"],
  ],
  [
    /milestone-map/,
    "Productivity",
    "Coordination & planning",
    ["roadmaps", "teams", "planning"],
  ],
  [
    /playlist-pass/,
    "Creative",
    "Performance & sound",
    ["music", "parties", "shared media"],
  ],
  [
    /pair-mixer/,
    "Coordination",
  ...
  [
    ...
    "Social",
    "Celebration & support",
    ["appreciation", "team rituals", "standups"],
  ],
  [
    /^room-soundtrack$/,
    "Creative",
    "Performance & sound",
    ["music", "shared media", "co-located groups"],
  ],
